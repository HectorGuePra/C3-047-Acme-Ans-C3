...
@GuiController
public class AdministratorAircraftGuiController extends AbstractGuiController<Administrator, Aircraft> {
	...
	@Autowired
	private AdministratorAircraftPublishService publishService;
