...
<acme:form>
	...
	<acme:input-select code="flight-crew-member.flight-assignment.form.label.flightCrewMember" path="allocatedFlightCrewMember" choices="${flightCrewMemberChoice}" readonly="true"/>
